    ...
    return (
        <form onSubmit={handleFormSubmit} className="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
            ...
            <div className="mb-4">
                ...
                <input onChange={e => setPassword(e.target.value)} value={password} id="password" type="password" className={"form-control fs-5" + (passwordErr ? " is-invalid" : "")} required="" />
                <div className="invalid-feedback">{passwordErr}</div>
            </div>
            <div className="mb-4">
                <input onChange={e => setTos(tos ? '' : e.target.value)} checked={!!tos} className={"form-check-input me-2 mt-0" + (tosErr ? ' is-invalid' : '')} style={{ width: '1.5rem', height: '1.5rem' }} type="checkbox" value="agree" id="tos" required="" />
